...
public class ZYImageView extends ImageView
{
    ...
    public ZYImageView(Context context, AttributeSet attrs) {
        this(context,attrs, 0);
        // TODOAuto-generated constructor stub
    }

    public ZYImageView(Context context, AttributeSet attrs,int defStyle){
