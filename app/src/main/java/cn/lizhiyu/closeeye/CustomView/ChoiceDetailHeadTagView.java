...
public class ChoiceDetailHeadTagView extends RelativeLayout
{
    ...
    public ChoiceDetailHeadTagView(Context context, @Nullable AttributeSet attrs)
    {
        ...
        button = findViewById(R.id.choicedetail_tag_button);
    ...
    {
//        Glide.with(contextSupper).load(model.coverUrl).bitmapTransform(new RoundedCornersTransformation(contextSupper,15,0, RoundedCornersTransformation.CornerType.ALL)).into(button);
