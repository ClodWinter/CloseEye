package cn.lizhiyu.closeeye.Animations;

import android.support.v4.view.ViewPager;
import android.view.View;

/**
 * Created by lizhiyu on 2018/3/1.
 */

public class DiscListHeadTrans implements ViewPager.PageTransformer
{
    ...
    public DiscListHeadTrans(ViewPager pager){
        mViewPager = pager;
    }
