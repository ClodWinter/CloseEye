...
public class ForgetPasswordActivity extends AppCompatActivity {
    ...
    {
        ImageView imageViewClose = (ImageView) findViewById(R.id.activity_forget_close);
        ...
        final EditText editTextAccount = (EditText) findViewById(R.id.forget_account_edittext);

        final EditText editTextPass = (EditText) findViewById(R.id.forget_pass_edittext);

        final EditText editTextCode = (EditText) findViewById(R.id.forget_vali_edittext);

        final EditText editTextPassAgain = (EditText) findViewById(R.id.forget_again_pass_edittext);

        final ImageView imageViewAction = (ImageView) findViewById(R.id.forget_button);

        final TextView textViewGetCode = (TextView) findViewById(R.id.forget_getValiCode);
        ...
        textViewGetCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(ForgetPasswordActivity.this,"手机号码格式不正确",Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(ForgetPasswordActivity.this,"验证码已发送，请注意查收。",Toast.LENGTH_LONG).show();
                ...
                final CountDownTimer timer = new CountDownTimer(60000,1000) {
                    ...
                    {
                        textViewGetCode.setText(t/1000+" 秒后重发");
                    }
        ...
        final Button buttonCheck = (Button) findViewById(R.id.register_check);
        ...
        buttonCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    buttonCheck.setBackgroundResource(R.drawable.check_box);
                }else
                {
                    buttonCheck.setBackgroundResource(R.drawable.uncheck_box);
                }
            }
        });
